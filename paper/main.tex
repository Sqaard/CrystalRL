...
a different object and scores $\textsc{CrystalScore}{=}0.03$ ($F{=}0.03$) --- it is legible and
stable but \emph{not} a faithful command surface, which is one more reason DP remains champion.
...
\begin{figure}[t]
  ...
  survives. A: the head scores $\textsc{CrystalScore}=0.03$ ($F\,0.03\times S\,1.0\times S\!t\,1.0$)
  --- a legible, stable dial, not a faithful command surface.}
  \label{fig:levers}
\end{figure}
